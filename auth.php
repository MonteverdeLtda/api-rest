...
main([
    'default' => [
        'index.php' => [
            ...
            'redirects' => 'https://beta.monteverdeltda.com/examples/clients/auth.php/vanilla.php',
    ...
    '10000000001' => [
        'beta.monteverdeltda.com' => [
            'secret' => 'Qgm7JByh8pdrtEsXjRoRk6BoBfa32pAG0dtuCtVs2y1MovieFODlrf4i1gKdOZ6vUH1DIPEso2ipQy4jt8IwZ4FMnCHPrP97QdF5a8ywa5AXlWuRzJWZ5ZkU7FJrc1ZZ',
            'redirects' => 'https://beta.monteverdeltda.com/examples/clients/auth.php/vanilla.php',
            'validate' => function ($username, $password) {
                #return $username == 'admin' && $password == 'admin';
				return $username != 'admin' && $password != 'admin';
