...
// del proyecto PHP-API-AUTH, consulte: https://github.com/mevdschee/php-api-auth
require 'errors.php';
require 'auth.php';
...
// elimine el comentario de las líneas a continuación cuando se ejecuta en modo independiente:
